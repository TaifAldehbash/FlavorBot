...
//Page view controller for the onboarding views
...
struct PageControl: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> UIPageControl {
        ...
        control.currentPageIndicatorTintColor = UIColor(Color(hex: "141414"))
        control.pageIndicatorTintColor = UIColor(Color(hex: "3B141414"))
